...
const std::map<const std::pair<const u16, const u16>, SkyData> list_skylanders = {
    ...
    {{3, 0x1814}, {"Lightning Rod (Metallic Purple)", Game::Giants, Element::Air, Type::Skylander}},
    ...
    {{14, 0x1817}, {"Gill Grunt (Metallic Green)", Game::Giants, Element::Water, Type::Skylander}},
    ...
    {{26, 0x2C02}, {"Stealth Elf (Dark Ninja)", Game::SwapForce, Element::Life, Type::Skylander}},
    ...
    {{27, 0x1814}, {"Stump Smash (White Flocked)", Game::Giants, Element::Life, Type::Skylander}},
    ...
    {{113, 0x1017}, {"Shroomboom (Metallic Green)", Game::Giants, Element::Life, Type::Skylander}},
    ...
    {{114, 0x1214}, {"Eye-Brawl (Metallic Purple)", Game::Giants, Element::Undead, Type::Giant}},
    ...
    {{201, 0x0002}, {"Hidden Treasure (Platinum)", Game::Giants, Element::Other, Type::Item}},
    ...
    {{210, 0x3002}, {"Magic Log Holder", Game::TrapTeam, Element::Magic, Type::Trap}},
    ...
    {{215, 0x3009}, {"Fire Scepter", Game::TrapTeam, Element::Fire, Type::Trap}},
    ...
    {{230, 0x3000}, {"Hand of Fate", Game::TrapTeam, Element::Other, Type::Item}},
    ...
    {{483, 0x3000}, {"Spotlight", Game::TrapTeam, Element::Light, Type::Skylander}},
    ...
    {{505, 0x0000}, {"Terrabite (Sidekick)", Game::SpyrosAdv, Element::Earth, Type::Mini}},
    ...
    {{514, 0x0000}, {"Gill Runt (Sidekick)", Game::SpyrosAdv, Element::Water, Type::Mini}},
    {{514, 0x3000}, {"Gill Runt", Game::TrapTeam, Element::Water, Type::Mini}},
    {{519, 0x0000}, {"Trigger Snappy (Sidekick)", Game::SpyrosAdv, Element::Tech, Type::Mini}},
    {{519, 0x3000}, {"Trigger Snappy", Game::TrapTeam, Element::Tech, Type::Mini}},
    {{526, 0x0000}, {"Whisper Elf (Sidekick)", Game::SpyrosAdv, Element::Life, Type::Mini}},
    ...
    {{2005, 0x2004}, {"Fire Kraken (Gold) (Top)", Game::SwapForce, Element::Fire, Type::Swapper}},
    ...
    {{3003, 0x2016}, {"Scorp (Green)", Game::SwapForce, Element::Earth, Type::Skylander}},
    ...
    {{3005, 0x2219}, {"Snowderdash (LightCore)", Game::SwapForce, Element::Fire, Type::Skylander}},
    ...
    {{3008, 0x2004}, {"Dune Bug (Metallic Red)", Game::SwapForce, Element::Magic, Type::Skylander}},
    ...
    {{3221, 0x401E}, {"Tomb Buggy (Bronze)", Game::Superchargers, Element::Undead, Type::Vehicle}},
    ...
    {{3401, 0x411E}, {"High Volt (Patina)", Game::Superchargers, Element::Tech, Type::Skylander}},
